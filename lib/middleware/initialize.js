...
module.exports = function initialize(passport, options) {
  ...
  return function initialize(req, res, next) {
    ...
    if (compat) {
      ...
      //
      // [1]: https://github.com/jscott/passport/pull/875
      // [2]: https://github.com/jscott/passport/blob/v0.4.1/lib/http/request.js
      // [3]: https://github.com/jscott/passport/blob/v0.5.1/lib/middleware/authenticate.js#L96
      // [4]: https://github.com/jscott/passport/issues/877
